...
if (isset($_POST['simpan'])) {
    ...
    if (empty($nim) || empty($nama) || empty($email) || empty($jurusan) || empty($jenis_kelamin) || empty($tanggal_lahir) || empty($telepon) || empty($alamat)) {
        ...
        $stmt_check = mysqli_prepare($koneksi, "SELECT id FROM mahasiswa WHERE nim = ?");
        ...
        if (mysqli_stmt_num_rows($stmt_check) > 0) {
            ...
            if (empty($error)) {
                $stmt_insert = mysqli_prepare($koneksi, "INSERT INTO mahasiswa (nim, nama, email, jurusan, jenis_kelamin, tanggal_lahir, telepon, alamat, status, foto) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                mysqli_stmt_bind_param($stmt_insert, "ssssssssss", $nim, $nama, $email, $jurusan, $jenis_kelamin, $tanggal_lahir, $telepon, $alamat, $status, $foto_name);
                ...
                <div class="col-lg-8">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nim" name="nim" placeholder="Contoh: A11.2023.14901" required>
                        </div>
                        
                        <!-- Nama -->
                        <div class="col-md-6">
                            <label for="nama" class="form-label">Nama Lengkap</label>
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama mahasiswa lengkap" required>
                        </div>
                        
                        <!-- Email -->
                        <div class="col-md-6">
                            <label for="email" class="form-label">Surel (Email)</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="mahasiswa@email.com" required>
                        </div>
                        
                        <!-- Jurusan -->
                        <div class="col-md-6">
                            <label for="jurusan" class="form-label">Program Studi (Jurusan)</label>
                            <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Contoh: Teknik Informatika" required>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat tinggal mahasiswa saat ini" required></textarea>
                        </div>
